...
train_subs = sub_labels[org_train_inds]
assert len(np.unique(train_subs)) == 20
test_subs = sub_labels[org_test_inds]
assert len(np.unique(test_subs)) == 20
